...
## The Journey (11 Milestones)

| # | Milestone | What you do | Time |
|---|-----------|-------------|------|
...
| 9 | [Deploy to EC2](09-deploy-to-ec2.md) | Put your app on AWS, reachable worldwide | 40 min |
| 10 | [Domain & HTTPS](10-domain-and-https.md) | Real domain + free SSL (optional) | 35 min |
| 11 | [Security & Final Check](11-security-and-final-check.md) | Harden and finish (optional) | 25 min |
...
┌─────────────────────────────┐            ┌─────────────────────────┐
│ Docker Desktop runs your    │            │ EC2 Server runs your    │
